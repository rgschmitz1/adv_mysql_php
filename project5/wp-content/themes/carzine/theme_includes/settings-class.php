<?php
if ( !class_exists( 'carzine_Settings_API' ) ):
class carzine_Settings_API {
    ...
    function show_navigation() {
        ...
        $html = '<h1>Carzine 1.2.5 Theme Settings</h1>';
        $html .='<div class="admin-premium-theme">
                <p>The premium version of Carzine is under development and it will available very soon!</p>

                <p>Check out the premium feautures of Carzine and sign up now to our newsletter to keep updated about our new releases and offers!</p>';
        
        $html .='<a target="blank" class="admin_btn" href="'.esc_url('http://takimi.info/carzine/#premium').'"><img src="'.IMG_PATH.'premiumfeatures.jpg"></a>';
        
        $html .='<a target="blank"  class="admin_btn" href="'.esc_url('http://eepurl.com/YB01H').'"><img src="'.IMG_PATH.'newsletter.jpg"></a>  
